...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            logger.info(f"Loading data from train path{self.train_path}")
            train_df = load_data(self.train_path)

            logger.info(f"Loading data from test {self.test_path}")
            ...
            logger.error(f"Got error while loading and splitting data {e}")
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.error(f"Got error while training model {e}")
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.error(f"Got error while evaluating model {e}")
    ...
    def save_model(self, model):
        try:
            ...
            logger.info(f"Model saved successfully {self.model_output_path}")
        
        except Exception as e:
            logger.error(f"Got error while saving model {e}")
    ...
    def run(self):
        try:
            ...
            logger.error(f"Got error while running model training pipeline {e}")
